...
> **Required env var:** `SESSION_ID` — your KnightBot session string (starts with `KnightBot!`).
> Get it by pairing your WhatsApp number at the KnightBot site, then paste the full string.
...
4. Go to **Variables** tab → Add:
   - `SESSION_ID` = `KnightBot!......` (your full session string)
...
2. Click "Deploy to Heroku" or:
   ...
   heroku config:set SESSION_ID="KnightBot!......"
...
5. After pairing, you'll get a string starting with `KnightBot!......`. Copy the whole thing.
